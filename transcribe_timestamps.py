...
def format_timestamp(seconds: float) -> str:
    """Converts seconds (float) into HH:MM:SS format."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Transcribe spoken language from an audio file into text with timestamps."
    )
    ...
    try:
        ...
        # Output Results by segmenting the timeline
